...
├── backend/                  # FastAPI server (serves API + frontend)
│   └── server.py
...
5. **Run the web app**
   ...
   The app lets you:
   - Sign ASL letters via webcam — letters are combined into words automatically
   - Build sentences with **End Word** (or the space sign)
   - Hear your text with the **Speak** button (browser text-to-speech)
